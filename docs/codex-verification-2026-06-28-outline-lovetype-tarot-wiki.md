...
## 10. 2026-06-28 업데이트 — 남은 스토어 작업 반영

요청: `아웃라인에 남은 작업 포함해서 업데이트 해줘`
...
- 스토어 등록 직전 로컬 완료 상태 추가
- `tools/verify_store_readiness.ps1` readiness verifier 추가 반영
- `.github/workflows/store-readiness.yml` CI readiness workflow 추가 반영
- 남은 외부 작업 명시:
...
| 문서 | ID | URL | 상태 |
|---|---|---|---|
| LoveType Tarot 프로젝트 위키 | `17a3d809-d100-4c8f-82e6-b8299e5eb1b0` | `https://outline-production-20a7.up.railway.app/doc/lovetype-tarot-AE5jC4JOxj` | updated, verified |
| LoveType Tarot 개발진행 히스토리 | `21586067-cd44-46b1-b5e9-1428834fc8f9` | `https://outline-production-20a7.up.railway.app/doc/lovetype-tarot-gEOugCby9f` | updated, verified |
| LoveType Tarot 완료보고서 인덱스 | `2722f924-33de-42fe-a5b5-4bbc45653e00` | `https://outline-production-20a7.up.railway.app/doc/lovetype-tarot-MmxMzcSuSW` | updated, verified |
